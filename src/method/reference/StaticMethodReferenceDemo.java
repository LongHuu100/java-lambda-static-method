...
public class StaticMethodReferenceDemo {
	...
	public static void main(String[] args) {
		...
		// Here, a method reference to static method isEven of IntPredicatesChecker is
		// passed to numCheck().
		...
		// Here, a method reference to static method isPositive of IntPredicatesChecker
		// is passed to numCheck().
